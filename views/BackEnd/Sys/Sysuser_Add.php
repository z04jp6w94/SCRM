...
$sql .= " WHERE c_id not in ( select c_id from sysuser) ";
$sql .= " and parent_id = ? ";
$userAry = $mysqli->readArrayPreSTMT($sql, "s", array($c_id), 2);
?>
    ...
    <head>
        ...
        <script type="text/javascript">
            function chkFormField(createForm) {
                if (isFormDataEmpty(createForm.group_id, "系統群組名稱")) {
                } else if (isFormDataEmpty(createForm.user_status, "帳號是否啟用")) {
                } else if (isFormDataEmpty(createForm.user_account, "系統使用者帳號")) {
                } else if (isFormDataEmpty(createForm.user_password, "系統使用者密碼")) {
                } else if (isFormDataEmpty(createForm.user_name, "系統使用者姓名")) {
                } else if (isFormDataEmpty(createForm.user_email, "系統使用者信箱")) {
                } else {
                    createForm.submit();
                }
            }
                ...
                <div id="MainDesc">
                    <table width="100%" border="0" cellpadding="4" cellspacing="0" class="power-Font03">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="user_status" id="user_status" value="Y" />是
                                <input type="radio" name="user_status" id="user_status" value="N" />否
                            </td>
                        </tr>
                        <tr>
                            <td><div align="right">系統使用者帳號：</div></td>
                            <td><input  type="text" name="user_account" id="user_account" size="60" maxlength="100" value="" /></td>
                        </tr>
                        <tr>
                            <td><div align="right">系統使用者密碼：</div></td>
                            <td><input  type="text" name="user_password" id="user_password" size="60" maxlength="100" value="" /></td>
                        </tr>
                        <tr>
                            <td><div align="right">系統使用者姓名：</div></td>
                            <td><input  type="text" name="user_name" id="user_name" size="60" maxlength="100" value="" /></td>
                        </tr>
                        <tr>
                            <td><div align="right">系統使用者地址：</div></td>
                            <td><input  type="text" name="user_address" id="user_address" size="60" maxlength="100" value="" /></td>
                        </tr>
                        <tr>
                            <td><div align="right">系統使用者信箱：</div></td>
                            <td><input  type="text" name="user_email" id="user_email" size="60" maxlength="100" value="" /></td>
                        </tr>
                        <tr>
                            <td><div align="right">系統使用者電話：</div></td>
                            <td><input  type="text" name="user_phone" id="user_phone" size="60" maxlength="100" value="" /></td>
                        </tr>
                    </table>
                </div>
            </form>
