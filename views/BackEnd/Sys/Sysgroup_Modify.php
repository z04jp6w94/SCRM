...
$sql .= " and c_id = ? ";
$rsVal = $mysqli->readValuePreSTMT($sql, "ss", array($dataKey, $c_id), 1);
?>
    ...
    <head>
        ...
        <script type="text/javascript">
            function chkFormField(updateForm) {
                if (isFormDataEmpty(updateForm.group_name, "系統群組名稱")) {
                } else {
                    updateForm.submit();
                }
            }
                ...
                <div id="MainDesc">
                    <table width="100%" border="0" cellpadding="4" cellspacing="0" class="power-Font03">	
                        <tr>
                            ...
                            <td><input type="text" name="group_name" id="group_name" size="60" maxlength="100" value="<?php echo $rsVal; ?>" /></td>
                        </tr>
                    </table>
                </div>
            </form>
