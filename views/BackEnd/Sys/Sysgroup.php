                    ...
                    case "updateBatch":
                        ...
                        for (var i = 0; i < <?php echo $currentPageRecord; ?>; i++) {
                            if (document.getElementById("rowNum" + (i + 1)).checked) {
                                if (isFormDataEmpty(document.getElementById("group_name" + (i + 1)), "系統群組名稱")) {
                                    return;
                                }
                            }
                        }
            ...
            <div id="MainTitle">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/assets_rear/images/TdBg01.gif">
                    <tr class="power-Font03" height="29">
                        ...
                        <td width="" class="TRMM-td01 TRMM-alignLeft">系統群組權限設定</td> 
                    </tr>
                    <tr>
                    ...
                    <form name="Form2" id="Form2" method="post">
                        ...
                        <?php foreach ($initAry as $rsAry) { ?>    
                            ...
                            <tr<?php if ($rowNum % 2 == 1) echo ' bgcolor="#F1F5FA"'; ?> onMouseOut="cbar(this)" onMouseOver="sbar(this)">
                                ...
                                <td width="50" height="28" class="TRMM-td01 TRMM-align"><?php if ($rsAry[0] != '1' && $rsAry[0] != '2') { ?><input type="checkbox" name="rowNum<?php echo $rowNum ?>" id="rowNum<?php echo $rowNum ?>" value="<?php echo $rsAry[0]; ?>" onClick="checkSingle(Form2);" /><?php } ?></td>
                                <?php if ($update == "abled") { ?>
                                ...
                                <td width="" class="TRMM-td01 TRMM-alignLeft">
                                    <a href="Sysauthority_Modify.php?fileName=<?php echo $fileName; ?>&currentPage=<?php echo $currentPage; ?>&currentPageRecord=<?php echo $currentPageRecord; ?>&dataKey=<?php echo $rsAry[0]; ?>">
