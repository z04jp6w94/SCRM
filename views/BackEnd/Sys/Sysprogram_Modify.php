...
$sql = "SELECT program_name, program_path FROM sysprogram WHERE program_id = ?";
    ...
    <head>
        ...
        <script type="text/javascript">
            function chkFormField(updateForm) {
                if (isFormDataEmpty(updateForm.program_name, "系統程式名稱")) {
                } else if (isFormDataEmpty(updateForm.program_path, "系統程式路徑")) {
                } else {
                    updateForm.submit();
                }
            }
                ...
                <div id="MainDesc">
                    <table width="100%" border="0" cellpadding="4" cellspacing="0" class="power-Font03">
                        <tr>
                            ...
                            <td><input  type="text" name="program_name" id="program_name" size="60" maxlength="100" value="<?php echo $initAry[0][0]; ?>" /></td>
                        </tr>
                        <tr>
                            <td><div align="right">系統程式路徑：</div></td>
                            <td><input  type="text" name="program_path" id="program_path" size="60" maxlength="100" value="<?php echo $initAry[0][1]; ?>" /></td>
                        </tr>  
                    </table>
                </div>
            </form>
