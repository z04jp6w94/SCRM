...
//取得查詢參數
$sProgram_name = !empty($_REQUEST["sProgram_name"]) ? $_REQUEST["sProgram_name"] : NULL;
//資料庫連線
$mysqli = new DatabaseProcessorForChiliman();
$sqlFrom = " FROM sysprogram";
$sqlWhere = " WHERE 1 = 1";
if (!empty($sProgram_name))
    $sqlWhere .= " AND a.program_name = '" . $sProgram_name . "'";
//確認使用者權限
$create = "disabled";
$read = "disabled";
$update = "disabled";
...
//取得畫面內容
$sql = "SELECT program_id, program_name, program_path";
$sql .= $sqlFrom;
$sql .= $sqlWhere;
$sql .= " LIMIT ?, ?";
    ...
    <head>
        ...
        <script type="text/javascript">
            function changePage(action) {
                ...
                url += '&sProgram_name=<?php echo $sProgram_name; ?>';
                    ...
                    case "updateBatch":
                        ...
                        for (var i = 0; i < <?php echo $currentPageRecord; ?>; i++) {
                            if (document.getElementById("rowNum" + (i + 1)).checked) {
                                if (isFormDataEmpty(document.getElementById("program_name" + (i + 1)), "系統程式名稱")) {
                                    return;
                                }
                            }
                        }
        ...
        <div id="MainTip">
            <form id="Form1" name="Form1" method="post">
                <ul class="TipMenunav">
                    <li class="TipIpt">
                        <ul>
                            <li>系統程式名稱：<input type="text" name="sProgram_name" id="sProgram_name" value="" maxlength="50" style="width: 300px;" /></li>
                        </ul>
                    </li>
                    <li class="TipBtn">
                        <ul>
            ...
            <div id="MainTitle">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/assets_rear/images/TdBg01.gif">
                    <tr class="power-Font03" height="29">
                        ...
                        <td width="" class="TRMM-td01 TRMM-alignLeft">系統程式路徑</td>    
                    </tr>
                    <tr>
                    ...
                    <form name="Form2" id="Form2" method="post">
                        ...
                        <?php foreach ($initAry as $rsAry) { ?>    
                            ...
                            <tr<?php if ($rowNum % 2 == 1) echo ' bgcolor="#F1F5FA"'; ?> onMouseOut="cbar(this)" onMouseOver="sbar(this)">
                                ...
                                <?php } ?>    
                                <td width="200" class="TRMM-td01 TRMM-alignLeft"><input type="text" name="program_name<?php echo $rowNum ?>" id="program_name<?php echo $rowNum ?>" size="60" maxlength="100" value="<?php echo $rsAry[1]; ?>" style="width: 180px;" /></td>  
                                <td width="" class="TRMM-td01 TRMM-alignLeft"><?php echo $rsAry[2]; ?></td>     
                            </tr>
                        <?php } ?>
                        <tr>
                            <td height="1" colspan="14" bgcolor="#E2E2E2"></td>
